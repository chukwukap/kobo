...
interface IOrderBook {
     ...
     *@param size of the order in the specified precision.
     ...
     */
    event FlipOrderCanceled(uint40[] orderIds, address owner);
    ...
    event OrderCanceled(uint40[] orderId, address owner);
     ...
     * @param orderId Order Id of the order that was filled. PS. All data regarding the original order can be found out from the order ID
    ...
    function addFlipSellOrder(uint40[] calldata _orderIds) external;
